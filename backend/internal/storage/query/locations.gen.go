...
func newLocation(db *gorm.DB, opts ...gen.DOOption) location {
	...
	_location.CreatedBy = field.NewString(tableName, "created_by")
	_location.DeletedAt = field.NewField(tableName, "deleted_at")
	_location.Var = field.NewInt64(tableName, "var")
	_location.Name = field.NewString(tableName, "name")
	_location.IsActive = field.NewBool(tableName, "is_active")
	_location.Coordinate = field.NewString(tableName, "coordinate")
...
func (l *location) updateTableName(table string) *location {
	...
	l.Var = field.NewInt64(table, "var")
	l.Name = field.NewString(table, "name")
	l.IsActive = field.NewBool(table, "is_active")
	l.Coordinate = field.NewString(table, "coordinate")
...
func (l *location) fillFieldMap() {
	...
	l.fieldMap["var"] = l.Var
	l.fieldMap["name"] = l.Name
	l.fieldMap["is_active"] = l.IsActive
	l.fieldMap["coordinate"] = l.Coordinate
}
