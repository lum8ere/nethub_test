...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.CreatedBy = field.NewString(tableName, "created_by")
	...
	_user.AvatarFilePath = field.NewString(tableName, "avatar_file_path")
...
func (u *user) updateTableName(table string) *user {
	...
	u.AvatarFilePath = field.NewString(table, "avatar_file_path")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["avatar_file_path"] = u.AvatarFilePath
}
