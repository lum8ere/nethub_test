...
func newDevice(db *gorm.DB, opts ...gen.DOOption) device {
	...
	_device.CreatedBy = field.NewString(tableName, "created_by")
	...
	_device.PlatformCode = field.NewString(tableName, "platform_code")
	_device.IP = field.NewString(tableName, "ip")
	_device.Hostname = field.NewString(tableName, "hostname")
	_device.Location = field.NewString(tableName, "location")
	_device.IsActive = field.NewBool(tableName, "is_active")
...
func (d *device) updateTableName(table string) *device {
	...
	d.PlatformCode = field.NewString(table, "platform_code")
...
func (d *device) fillFieldMap() {
	...
	d.fieldMap["platform_code"] = d.PlatformCode
	d.fieldMap["ip"] = d.IP
