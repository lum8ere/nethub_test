...
type DeviceService interface {
	...
	List(ctx context.Context, hostname string, isActive *bool) ([]*model.Device, error)
...
func (s *deviceService) List(ctx context.Context, hostname string, isActive *bool) ([]*model.Device, error) {
	d := s.q.Device
	q := d.WithContext(ctx)
